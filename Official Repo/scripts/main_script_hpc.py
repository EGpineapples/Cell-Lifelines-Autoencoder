...
if __name__ == "__main__":
    ...
    folder_path = "src/data/100_dFBA_Lifelines"
    ...
    latent_file_path_standard = "src/models/latent_representations_standard.xlsx"
    ...
    plot_save_path_standard = "plots/lifeline_reconstruction_standard.png"
    ...
    latent_file_path_timesteps = "src/models/latent_representations_timesteps.csv"
    save_latent_representations(best_model_timesteps, normalized_data, latent_file_path_timesteps)

    plot_save_path_timesteps = "plots/lifeline_reconstruction_timesteps.png"
