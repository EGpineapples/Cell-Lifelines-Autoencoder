...
latent_data_file <- "D:/Desktop/Work/Multiple Lifelines/latent_representations_100_lifelines_just_biomass.csv"
...
```{r}
# Make sure you have Rtsne installed
...
# Plotting function, similar to before but for t-SNE dimensions
plot_clusters_tsne <- function(tsne_dim1, tsne_dim2, clusters) {
  plot(tsne_dim1, tsne_dim2, col = clusters, pch = 16,
       xlab = "Dimension 1", ylab = "Dimension 2", main = "t-SNE Clusters",
       cex = 1.5, las = 1)
  legend("topright", legend = unique(clusters), fill = 1:max(clusters))
}

# Assuming `fit$clustering` holds the cluster assignments for each point
plot_clusters_tsne(tsne_dim1, tsne_dim2, fit$clustering)
