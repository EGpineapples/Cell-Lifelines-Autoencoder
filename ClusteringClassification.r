...
table.all <- read.csv(data_file, header = TRUE, sep = "\t", check.names = FALSE)
...
plot.silhouette <- function(fit) {
  plot(silhouette(fit), main = "Silhouette Plot")
}

# Call the function to display the silhouette plot
plot.silhouette(fit)
